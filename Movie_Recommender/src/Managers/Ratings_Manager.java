...
public class Ratings_Manager {
    ...
    public Ratings_Manager(FileReader reader, ArrayList<RatingsWatcher<Movie>> ListOfUsers, ArrayList<Movie> ListOfMovies) {
        reader.ReadRatings(ListOfUsers, ListOfMovies);
